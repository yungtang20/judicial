const fs = require('fs');
let code = fs.readFileSync('src/components/LegalToolbox.tsx.new', 'utf-8');
...
code = code.replace(/export interface LegalToolboxProps/, suggestComponent + '\nexport interface LegalToolboxProps');
fs.writeFileSync('src/components/LegalToolbox.tsx', code);
