...
export interface ToolDefinition {
  id: string;
  categoryGroup: 'SAFETY' | 'DAMAGES' | 'FAMILY' | 'ELDERLY' | 'DEBT_EXECUTION' | 'HOUSING_WORK' | 'GENERAL';
...
export const LEGAL_TOOLS: ToolDefinition[] = [
  // Group 1: 刑事告訴與附帶民事 (7)
  {
    ...
    categoryGroup: 'DAMAGES',
    categoryLabel: '車禍與損害賠償',
    name: '車禍過失傷害刑事告訴狀',
  ...
  // Group 4: 債權保全、借據與票據非訟 (4)
  {
    ...
    categoryGroup: 'DEBT_EXECUTION',
    categoryLabel: '借款欠款與執行',
    name: '本票裁定強制執行聲請狀',
  ...
  },
  {
    ...
    categoryGroup: 'HOUSING_WORK',
    categoryLabel: '租屋房產與職場',
