  ...
  return (
    <div className="bg-white border border-slate-200 rounded-xl p-5 shadow-sm space-y-4">
      ...
      <div className="space-y-3 text-xs">
          ...
          <div>
            ...
            <div className="flex gap-1">
              <input
                ...
                className="w-16 px-2 py-1.5 rounded-lg border border-slate-200 text-slate-800 text-xs focus:ring-2 focus:ring-amber-500/20 focus:border-amber-500 outline-none text-center"
              />
              <input
                type="text"
                value={clientName}
                onChange={(e) => setClientName(e.target.value)}
                className="flex-1 px-2.5 py-1.5 rounded-lg border border-slate-200 text-slate-800 text-xs focus:ring-2 focus:ring-amber-500/20 focus:border-amber-500 outline-none"
              />
            </div>
          </div>
          <div>
            <label className="block font-medium text-slate-700 mb-1">對方稱謂 / 姓名</label>
            <div className="flex gap-1">
              <input
                type="text"
                value={opponentRole}
        ...
        <div>
           <label className="block font-medium text-slate-700 mb-1">代理人律師姓名</label>
           <input
             type="text"
             value={lawyerName}
        ...
        <div>
          <label className="block font-medium text-slate-700 mb-1">全案背景摘要 (全局)</label>
          <textarea
            rows={3}
            value={caseBackground}
            onChange={(e) => setCaseBackground(e.target.value)}
            placeholder="訴訟背景..."
            className="w-full px-2.5 py-2 rounded-lg border border-slate-200 text-slate-800 text-xs focus:ring-2 focus:ring-amber-500/20 focus:border-amber-500 outline-none resize-none"
          />
        </div>
      ...
      <div className="mt-4 pt-4 border-t border-slate-100">
        <h4 className="font-bold text-slate-700 text-xs mb-2 flex items-center gap-1.5">
          <Book className="w-3.5 h-3.5 text-slate-400" /> 操作說明
        </h4>
