  ...
  return (
    <div className="relative">
      <button
        ...
        className="flex items-center gap-1 text-[10px] bg-indigo-500/10 hover:bg-indigo-500/20 text-indigo-300 border border-indigo-500/30 px-2 py-0.5 rounded-xl transition-all"
        disabled={isLoading}
      >
            ...
            <div className="flex flex-col gap-1.5">
              ...
              {options.map((opt, i) => (
                <button
                  ...
                  className="text-left text-xs p-2 rounded-xl bg-slate-900 hover:bg-slate-700 text-slate-200 border border-slate-700/50 transition-colors"
                >
                  {opt}
                </button>
              ))}
