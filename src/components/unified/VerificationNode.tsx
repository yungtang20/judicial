...
export const VerificationNode: React.FC<VerificationNodeProps> = (props) => {
  ...
  return (
    <div className={`rounded-xl border transition-colors overflow-hidden ${isPass ? 'bg-[var(--color-surface-raised)] border-emerald-500/40' : 'bg-[var(--color-status-danger-bg)] border-rose-500/40'}`}>
      {/* 節點 6 標頭：極簡條列化 */}
      <div
