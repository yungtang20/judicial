...
export const SCENARIOS: ScenarioItem[] = [
    // 0. 性侵害 / 妨害性自主 / 伴侶非自願性行為
    {
      ...
      plainDesc: '遭受他人或親密伴侶（女友/男友/同居人）違反意願強迫性交。臺灣刑法第221條男女平等受保護，且為「非告訴乃論公訴罪」，不受6個月告訴乃論限制，檢警知悉即應依法主動追訴。若事發仍在72小時內，請把握一站式驗傷採證黃金期；已逾時效者請改以數位事證、通訊紀錄與證人陳述為主軸。可提出刑事告訴並同步聲請保護令與民事求償。',
      ...
      timeInfo: '非告訴乃論（公訴罪）無6個月限制。採證保存時效為事發後72小時：仍在時效內者請勿沐浴更衣、直接前往急診採證；已逾時效者請以數位事證、通訊紀錄與證人陳述為主軸，並仍應就醫取得診斷證明書。',
