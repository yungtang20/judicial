  ...
  return (
    <div className="flex flex-col h-full max-w-3xl mx-auto">
      ...
      <div className="flex items-center justify-between px-4 py-3 border-b border-slate-800/80 bg-slate-900/60 shrink-0">
        ...
        {messages.length > 0 && (
          <button
            ...
            className="p-2 rounded-lg bg-slate-800 text-[var(--color-text-muted)] hover:text-white hover:bg-slate-700 transition-colors"
            title="清除對話紀錄"
          >
      ...
      <div className="flex-1 overflow-y-auto p-4 space-y-4">
        {messages.length === 0 && (
          <div className="flex flex-col items-center justify-center h-full text-center text-[var(--color-text-muted)] space-y-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 w-full max-w-md">
              {[
                ...
                <button
                  ...
                  className="text-left text-xs p-2.5 rounded-xl bg-slate-900/80 border border-slate-800/60 text-[var(--color-text-muted)] hover:text-white hover:border-indigo-500/40 transition-colors"
                >
                  {hint}
                </button>
              ))}
        ...
        {isLoading && (
          <div className="flex justify-start">
            <div className="bg-slate-900/80 border border-slate-800/60 rounded-2xl px-4 py-3 flex items-center gap-2 text-[var(--color-text-muted)]">
